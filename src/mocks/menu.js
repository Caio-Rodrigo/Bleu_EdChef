export const menu = [
	...
	},
	{
		name: 'Nhoque',
		description:
			'Os nhoques italianos são pequenos bolinhos do tamanho de um dedal feitos de batatas cozidas no vapor. Os bolinhos de nhoque têm uma forma oval típica com a impressão de um garfo. Eles são fervidos brevemente em água e servidos com um molho.',
		image:
			'https://www.takeaway.com/foodwiki/uploads/sites/11/2019/08/gnocchi_3-954x1080.jpg',
	},
	{
		name: 'Lasanha',
		description:
			'Lasanha é uma forma de massa e também o nome do prato feito desta forma de massa. Folhas largas e finas de massa são colocadas alternadamente no forno com um molho saboroso - geralmente um molho de carne de tomate - com queijo por cima.',
		image:
			'https://www.takeaway.com/foodwiki/uploads/sites/11/2019/08/lasagne_3-960x1080.jpg',
	},
	{
		name: 'Panna cotta',
		description:
			'Italiano panna cotta significa literalmente creme cozido (cotta) (panna). É uma das sobremesas mais simples do mundo: um pudim composto por creme de boa qualidade com possivelmente um pouco de leite, uma quantidade mínima de gelatina e um pouco de açúcar. Um toque de baunilha pode ser adicionado para dar um sabor sutil ao pudim.',
		image:
